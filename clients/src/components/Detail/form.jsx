...
function Form({ apartmentId }) {
  return (
    <div className="px-3 font-quicksand ">
      <span className=" text-center w-full block p-2  bg-black text-white mt-3 rounded-t-lg">
        Rent an apartment
      </span>
      ...
      <div className="py-4 px-3 rounded-lg shadow-light">
        ...
        <div className="my-5">
          <div className="mt-2">
            ...
            <div className="mt-2">
              <input
                type="text"
                name="name"
                className="w-full rounded-md border-0 py-1.5 shadow-light ring-1 ring-inset shadow-gray placeholder:text-gray-400 focus:ring-0 focus:ring-inset text-sm"
              />
            </div>
          </div>
          <div className="mt-2">
          ...
          <div className="flex justify-center items-center">
            <button className="bg-secondary py-2 px-3 hover:black text-white rounded-xl mt-2">
              Consultar
            </button>
          </div>
        </div>
