...
function CardApartAdmin({ apartment }) {
    const { images, urbanizacion, description, status } = apartment
    return (
        <div className=" w-full justify-between flex items-center font-quicksand text-gray-400 gap-2 border mt-2 p-1 rounded-lg">
            ...
            <div className="flex gap-2">
                <div className=" w-[40px] flex flex-col justify-center border p-1 rounded-lg items-center hover:bg-black text-blue-500 hover:text-white transition-all delay-300 cursor-pointer">
