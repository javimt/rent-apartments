        ...
        panelOptions.map((opt) => {
          return (
            <div
              ...
              className="flex font-quicksand items-center p-2 bg-white mt-2 rounded-xl  min-w-[150px] border-[1px] shadow-light hover:shadow-2xl cursor-pointer hover:border-[2px]"
            >
              <span></span>
