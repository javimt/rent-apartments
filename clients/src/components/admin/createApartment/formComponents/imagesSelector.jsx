...
function ImageSelector({ handle='', addFiles}) {
    ...
    return (
        <div className="flex flex-col gap-2 mx-2 my-2">
            ...
            <div className="flex">
                <input ref={element} placeholder={"Inserte URL de la imagen"}  type="text" className=" placeholder:text-[12px] w-full text-[12px] px-1 py-1 shadow-light border-[1px] text-gray-400 border-blue-950 rounded-md" />
            ...
            <div className="flex">
                <input onChange={(e)=> addFiles(e.target.files[0])} ref={element} placeholder={"Inserte URL de la imagen"}  type="file" />
            </div> 
        </div>
    );
}
