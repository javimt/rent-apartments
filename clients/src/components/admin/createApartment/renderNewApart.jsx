...
function RenderNewApartSection({ input }) {
    const { images, urbanizacion, bathrooms, bedrooms, size, description } = input
    return (
        <Transition className="flex flex-col items-center h-full shadow-2xl rounded-lg xl:mx-auto p-1 font-quicksand">
            ...
            <div className="flex flex-col justify-center mt-2">
                <div className="w-[400px] h-[250px]  bg-cover bg-center rounded-lg object-fill" style={{ backgroundImage: `url(${images && images[0] ? images[0] : 'https://t3.ftcdn.net/jpg/04/84/88/76/360_F_484887682_Mx57wpHG4lKrPAG0y7Q8Q7bJ952J3TTO.jpg'})` }}>
