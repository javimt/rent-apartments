    ...
    return (
        <Transition className='grid  px-4 md:py-20 md:px-36  font-quicksand xl:grid-cols-2 md:gap-28'>
            <div className="max-w-[100%]  mb-2 flex justify-center flex-col md:px-20">
                ...
                <h2 className='my-4 text-3xl font-semibold'>Consigue los mejores apartamentos amoblados, unidades modernas y seguras. sabeso lo que buscas al precio que necesitas</h2>
