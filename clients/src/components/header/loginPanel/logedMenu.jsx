...
function LogedMenu( {toogleOpen, openStatus} ) {
    ...
    return (
            <div onClick={toogleOpen} className="relative flex items-center text-gray-400 text-[13px] py-3 px-3 rounded-full shadow-xl focus:outline-none cursor-pointer border ">
